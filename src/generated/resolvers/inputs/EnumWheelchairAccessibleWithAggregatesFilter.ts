...
import { NestedEnumWheelchairAccessibleWithAggregatesFilter } from "../inputs/NestedEnumWheelchairAccessibleWithAggregatesFilter";
import { NestedIntFilter } from "../inputs/NestedIntFilter";
import { WheelchairAccessible } from "../../enums/WheelchairAccessible";

@TypeGraphQL.InputType("EnumWheelchairAccessibleWithAggregatesFilter", {
  isAbstract: true
})
export class EnumWheelchairAccessibleWithAggregatesFilter {
